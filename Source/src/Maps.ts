...
export class Map {
	...
	static ConstantMaps = ['CartoDB Positron', 'CartoDB Dark', 'OpenStreetMap Mapnik', 'Open Topo Map', 'Esri WorldPhysical', 'Esri NatGeo', 'Stamen Watercolor', 'Esri WorldShaded', 'Stamen Toner', 'Stamen Terrain' ];
	...
	static AddMapOption(val: MapOption) {

		if (Map.ConstantMaps.indexOf(val.name) !== -1 )
			return;
	...
	static DeleteMapOption(val: MapOption) {
